...

    {
        ...
        async void StartRpcServer()
        {
            try
            {
                ...
                _dpiRatioFirst = _previousDpi.DpiScaleX;
                var actualWidth = _wfh.PhysicalWidth * _previousDpi.DpiScaleX;
                var actualHeight = _wfh.PhysicalHeight * _previousDpi.DpiScaleY;
